...
document.getElementById("window-icon").addEventListener("click", function() {
    ipcRenderer.send("window-icon-context");
});
...
currentWindow.on('resize', () => {
    ...
    if (currentWindow.isMaximized()) {
        ...
        document.getElementById("tabs-container").style.top = "-3px";
        ...
        document.getElementById("tabs-container").style.top = "0px"
    ...
    ipcRenderer.send("editor-resized");
})