/* IDK where i got this code... But somehow I have it */
...
(function() {
    ...
    function appendElement(message) {
        if (document.body) {
            document.getElementById("dev-console").append(message);
        } else {
            ...
            switch (attr) {
                case 'clear':
                    window.console['clear'] = function clear() {
                        if (document.body) {
                            document.getElementById("dev-console").innerHTML = null;
                        }
